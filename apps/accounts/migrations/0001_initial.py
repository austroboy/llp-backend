# Generated by Django 5.1.15 on 2026-04-30 11:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('staff', 'Staff'), ('premium_user', 'Premium user'), ('free_user', 'Free user')], default='free_user', max_length=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('converted_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='guest_sessions', to=settings.AUTH_USER_MODEL)),
            ],
            options={
